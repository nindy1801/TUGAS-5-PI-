...
<html lang="en">
  ...
  <body>
      ...
      <h1><center>Data Mata kuliah</center></h1> 
          ...
          if ( !empty($result)) { 
            foreach ($result as $rslt) : ?> 
              ...
              <tr> 
                ...
                <td><?= $rslt->nama_mk ?></td> 
                <td> 
                   <a name="edit" id="edit"  class="btn btn-success" href="edit_matakuliah.php?id=<?= $rslt->id ?>">Edit</a> 
                 ...
                 <tr> 
                <td colspan="8">Belum ada data pada tabel mata kuliah.</td> 
              </tr> 
